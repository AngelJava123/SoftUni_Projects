...
public class TrainerServiceTest {
    ...
    void testGetAllTrainers() {
        ...
        Page<Trainer> trainers = new PageImpl<>(Arrays.asList(trainer1, trainer2, trainer3));

        Mockito.when(mockTrainerRepo.findAll(Pageable.unpaged())).thenReturn(trainers);

        toTest.getAllTrainers(Pageable.unpaged());

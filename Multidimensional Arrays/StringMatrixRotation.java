...
public class StringMatrixRotation {
    public static void main(String[] args) {
        ...
        int rotationDegree = Integer.parseInt(value);

        int numberOfRotations = rotationDegree % 360;
        ...
        rotate(numberOfRotations, rows, cols, matrix);
    }

    private static void rotate(int numberOfRotations, int rows, int cols, char[][] matrix) {
